function ToyModelSim()
  ...
  paramTogether = fminunc(@(X) sum((simMoments(X(1:3)) - m1_TRUE).^2) + ...
    sum((simMoments(X(4:6)) - m2_TRUE).^2), [TrueParam1.Beta1,TrueParam1.Beta2,TrueParam1.ProdParam,...
    TrueParam2.Beta1,TrueParam2.Beta2,TrueParam2.ProdParam]);
  ...
  paramTogether = fminunc(@(X) sum((simulateWages(X(1:3),simRounds,numWorkers) - m1_TRUE).^2) + ...
    ...
    [TrueParam1.Beta1,TrueParam1.Beta2,TrueParam1.ProdParam,...
    TrueParam2.Beta1,TrueParam2.Beta2,TrueParam2.ProdParam]);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  paramEst1_R            = paramTogether(1:3)
  paramEst2_R            = paramTogether(4:6)
  m2UsingProd1_ParR      = getMoments(betarnd(paramEst2_R(1),paramEst2_R(2),numWorkers,1).^paramEst1_R(3));
  m2UsingDist1_ParR      = getMoments(betarnd(paramEst1_R(1),paramEst1_R(2),numWorkers,1).^paramEst2_R(3));
